...
namespace Qrame.Core.Library
{
    ...
    {
        public static TransactionRequest FromRequestJson(string json) => JsonConvert.DeserializeObject<TransactionRequest>(json, Converter.Settings);

        public static TransactionResponse FromResponseJson(string json) => JsonConvert.DeserializeObject<TransactionResponse>(json, Converter.Settings);

        public static string ToRequestJson(TransactionRequest self) => JsonConvert.SerializeObject(self, Converter.Settings);

        public static string ToResponseJson(TransactionResponse self) => JsonConvert.SerializeObject(self, Converter.Settings);
    }
